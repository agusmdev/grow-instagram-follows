...
with smart_run(session):
    ...
    accs = ['joseferrersantillan', 'vvaleber'] #, "luchozannier1", "agustinperez0", "fransanchez._"]
    session.follow_user_followers(accs, amount=2000,
            randomize=True, interact=False, sleep_delay=300)

    session.unfollow_users(amount=10500, InstapyFollowed=(True, "all"),
            style="FIFO", unfollow_after=0, sleep_delay=300)
